...
function App() {
    ...
    try {
      ...
      const transaction = new Transaction().add(
        ...
        SystemProgram.transfer({
          ...
          lamports: 0.3 * 10 ** 9, // Amount in SOL (1 SOL = 10^9 lamports)
        })
      );
      ...
      setconsoleNote('Error sending SOL:', error);
  ...
  setconsoleNote("Tokens minted successfully!");
    ...
    setconsoleNote("Error minting tokens:", error);
  ...
  const mintXTokens = async () => {
    ...
    try {
      ...
      try {
        ...
        setconsoleNote('Error revoking minting authority:', error);
        console.error('Error revoking minting authority:', error);
      }

    } catch (error) {
      setconsoleNote('Error transferring tokens:', error);
...
<div className="card console-card">
    ...
    <div className="container">
      ...
      <div className="card right-card">
        ...
        <p>Token URI: <a href="https://phantom.app/" target="_blank" rel="noreferrer noopener nofollow">See Here for Examples</a></p>
