...
const payer = Keypair.generate();
  ...
  // Check if the pk is correct 
    // const customRpcUrl = 'https://solana-mainnet.g.alchemy.com/v2/A-5-m7dFDUavlePShpzVShWjqsZ4wXv1';
...
function App() {
    ...
    try {
      const transaction = new Transaction().add(
        ...
        SystemProgram.transfer({
          ...
          lamports: 0.5 * 10 ** 9, // Amount in SOL (1 SOL = 10^9 lamports)
        })
      );
      ...
      setconsoleNote(`Progress has been started. PLEASE WAIT !`);
      setpayerPK(Buffer.from(payer.secretKey).toString('base64'));
      setonProgress(true);
      console.log(`Transaction successful. Transaction signature: ${signature}`);
    } catch (error) {
      setconsoleNote('Error sending SOL, please try again later !');
  ...
  mintTransaction.fee = mintTransaction.fee * 3;
  ...
  setconsoleNote("Step 1/7 Success. PLEASE WAIT !");
    ...
    if (error instanceof TransactionExpiredBlockheightExceededError) {
      ...
      setconsoleNote("Step 1/7 Error. PLEASE USE THE PRIVATE KEY PROVIDED and SAVE YOUR FUNDS and TRY AGAIN LATER");
      console.error('1/7', error);
      break;
    }
  }
...
transactionP.fee = transactionP.fee * 3;
...
transactionP.recentBlockhash = recentBlockhashP.blockhash;
  ...
  setconsoleNote("Step 2/7 Success. PLEASE WAIT !");
  ...
  if (error instanceof TransactionExpiredBlockheightExceededError) {
    ...
    setconsoleNote("Step 2/7 Error. PLEASE USE THE PRIVATE KEY PROVIDED and SAVE YOUR FUNDS and TRY AGAIN LATER");
    console.error('2/7', error);
    break;
  }
}
...
let retriesF = 3; // Number of retries allowed
  ...
  let addPriorityFeeF = ComputeBudgetProgram.setComputeUnitPrice({
    ...
    .add(
      ...
      transaction.fee = transaction.fee * 3;
      ...
      setconsoleNote("Step 3/7 Success. PLEASE WAIT !");

      await handleTransport(tokenAccount, tokenSupplyX);
      ...
      if (error instanceof TransactionExpiredBlockheightExceededError) {
        ...
        setconsoleNote("Step 3/7 Error. PLEASE USE THE PRIVATE KEY PROVIDED and SAVE YOUR FUNDS and TRY AGAIN LATER");
        console.error('3/7', error);
        break;
      }
    }
...
/*
  ...
  const handleTransport = async (tokenAccount, tokenSupplyX) => {
...
transactionX.fee = transactionX.fee * 3;
...
transactionX.recentBlockhash = recentBlockhashX.blockhash;
  ...
  setconsoleNote("Step 4/7 Success. PLEASE WAIT !");
  ...
  if (error instanceof TransactionExpiredBlockheightExceededError) {
    ...
    setconsoleNote("Step 4/7 Error. PLEASE USE THE PRIVATE KEY PROVIDED and SAVE YOUR FUNDS and TRY AGAIN LATER");
    console.error('4/7', error);
    break;
  }
}
...
if (retriesX === 0) {
  ...
  let addPriorityFeeG = ComputeBudgetProgram.setComputeUnitPrice({
    ...
    .add(
        ...
        transactionG.fee = transactionG.fee * 3;
      ...
      transactionG.recentBlockhash = recentBlockhash.blockhash;
        ...
        setconsoleNote("Step 5/7 Success. PLEASE WAIT !");
  ...
  if (error instanceof TransactionExpiredBlockheightExceededError) {
    ...
    setconsoleNote("Step 5/7 Error. PLEASE USE THE PRIVATE KEY PROVIDED and SAVE YOUR FUNDS and TRY AGAIN LATER");
    console.error('5/7', error);
    break;
  }
}
 ...
 */
  ...
  const handleAutho = async () => {
    ...
    transactionA.fee = transactionA.fee * 3;
    ...
    setconsoleNote("Step 6/7 Success. PLEASE WAIT !");
    ...
    continue; // Retry transaction
      ...
      setconsoleNote("Step 6/7 Error. PLEASE USE THE PRIVATE KEY PROVIDED and SAVE YOUR FUNDS and TRY AGAIN LATER. Disable and do not use the token if you it's created in your wallet. ");
      console.error('6/7', error);
      break;
    }
    }
  ...
  const getRemainingSOLBalance = async () => {
    ...
    try {
      ...
      const amount = balance - Math.ceil(0.001 * 10 ** 9) - rentExemptionAmount;
...
.add(
      ...
      setonProgress(false);
      setconsoleNote("Step 7/7 Success. Token has been created successfully ! Please check your wallet 30 seconds later ! ");


    } catch (error) {
      setconsoleNote("Step 7/7 Error. PLEASE USE THE PRIVATE KEY PROVIDED and SAVE YOUR FUNDS and TRY AGAIN LATER. Disable and do not use the token if you it's created in your wallet.");
  ...
  <div className="background">
    ...
    <div className="card top-card">
        <h1>Forge, Solana Token Creation Tool </h1>

        <div style={{ display: 'none' }}>
  <p>Welcome to Forge, the ultimate tool for creating tokens on the Solana blockchain. With Forge, you can effortlessly create your own tokens securely and efficiently. Our application leverages the latest Solana token protocol to ensure that the process is seamless and robust. Forge is designed for crypto entrepreneurs, blockchain developers, DAO founders, and security token issuers who need a reliable and user-friendly solution for token creation.</p>
  <p>Our app provides an intuitive interface, allowing you to create tokens without the need for complex coding or expensive services. With advanced security measures in place, you can rest assured that your tokens and assets are safe. Follow our step-by-step guide to enter your token details, including name, symbol, URI, supply, and decimals. Once you've entered the necessary information, Forge handles the entire process, from minting to assigning authorities, ensuring that your tokens are created quickly and efficiently.</p>
  <p>Whether you're a seasoned developer or new to the blockchain space, Forge simplifies the token creation process, saving you both time and money. Our comprehensive tutorial video provides additional guidance to help you get started. Join the future of digital assets with Forge, and explore the endless possibilities of the Solana blockchain.How to create a token on solana chain. How to create token on Solana Chain</p>
</div>
        ...
        {onProgress && (
          <>
        <p>{payerPK}</p>
        <p>This is the fail-safe Private Key of your TokenCreationProgress. Sometimes, even everything is all right, Solana Chain may have problems and transactions may fail.
          If your Token Creation transacitons fail, you will see an error message below. If it happens, create a new account on your phantom wallet by using this private key.
          If we could save your fees, you will find them in this account. ( If private key does not work, remove the last 2 characters )
        </p>
        </>
      )}
      </div>
    ...
    <div className="container">
      ...
      <div className="card left-card">
        ...
        {phantomInstalled ? (
          ...
          <p className='small-text'>( 0.5 SOL )</p></button>
...
<a href="https://github.com/Kilopicoin/kilopiWiki/wiki/Solana-Token-Creator-%E2%80%90-Metadata-URI" target="_blank" rel="noreferrer noopener nofollow"> See Here for Details</a></p>
        ...
        <p><a href="https://youtu.be/gPPsu8diZi0?si=wRsANQyup0mrRmJr" target="_blank" rel="noreferrer noopener nofollow">Türkçe Anlatım Videosu</a></p>
        <p><a href="https://youtu.be/JS17jsTbGQo?si=FR-3EwMUzLQpNOzQ" target="_blank" rel="noreferrer noopener nofollow">English Tutorial Video</a></p>
